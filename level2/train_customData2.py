        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'train':
                if not os.path.exists('output'):
                    os.makedirs('output')
                torch.save(model, 'output/class2/resnet_epoch{}.pkl'.format(epoch))
...
if __name__ == '__main__':
    ...
    image_datasets = {x: customData(img_path='/home/jay_wu/winterholiday/ImageClassification-PyTorch/level2/ImagePath',
                                    txt_path=('/home/jay_wu/winterholiday/ImageClassification-PyTorch/level2/TxtFile/class2/' + x + '.txt'),
    ...
    # save best model
    torch.save(model_ft,"output/class2/best_resnet.pkl")
